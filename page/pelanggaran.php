...
mysqli_query($connect,"INSERT INTO setup_jenis_pelanggaran VALUES ('id_jenis','$nama_jenis','$point')") or die(mysqli_error());
?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                            <?php
                                        include '../koneksi/koneksi.php';
                                        $sql = mysqli_query($connect,"select * from setup_jenis_pelanggaran") or die (mysqli_error());
                                        $no=1;
