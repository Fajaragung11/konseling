...
$kdsis = @$_GET['kdsis'];
$sql = mysqli_query($connect,"select * from data_siswa where id_siswa ='$kdsis'") or die(mysqli_error());
...
?>
					...
					include '../koneksi/koneksi.php';
					$kdsis = @$_GET['kdsis'];
					$sql = mysqli_query($connect,"select * from data_orangtua where id_orangtua = '$kdsis'") or die(mysqli_error());
					$data = mysqli_fetch_array($sql);
					?>      
                                <div class="col-lg-6">
                                        <div class="form-group">
...
@$username = mysqli_reali_escape_string($_POST['username']);
@$password = mysqli_reali_escape_string($_POST['password']);
