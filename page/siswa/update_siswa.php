...
$sql_formulir = mysqli_query($connect,"select * from data_siswa where id_siswa = '$sesi'") or die(mysqli_error());
...
$sql_formulir = mysqli_query($connect,"select * from data_orangtua where id_orangtua = '$sesi'") or die(mysqli_error());
$data = mysqli_fetch_array($sql_formulir);
?>
                                <div class="col-lg-6">
                                        <div class="form-group">
...
$sql_formulir = mysqli_query($connect,"select * from data_saudara where id_saudara = '$sesi'") or die(mysqli_error());
$data = mysqli_fetch_array($sql_formulir);
?>
...
$tgl_a = mysqli_real_escape_string($_POST['tgl_a']);
$agama = mysqli_real_escape_string($_POST['agama']);
...
$agm2 = mysqli_real_escape_string($_POST['agm2']);
 ...
 $sql=mysqli_query($connect," UPDATE data_siswa SET nis='$nis',
...
$sql1=mysqli_query($connect,"UPDATE data_orangtua SET nis='$nis',
    ayah='$ayah',
    tl='$tl',
    tgl_a='$tgl_a',
    agama='$agama',
...
$sql2=mysqli_query($connect," UPDATE data_saudara SET nm='$nm',
    umur='$umur',
    jk='$jk',
    pddk='$pddk',
    krj='$krj',
