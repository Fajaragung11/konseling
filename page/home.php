...
$siswa =mysqli_num_rows(mysqli_query($connect,"SELECT * FROM data_siswa"));
$kelas =mysqli_num_rows(mysqli_query($connect,"SELECT * FROM setup_kelas"));
$pelanggaran =mysqli_num_rows(mysqli_query($connect,"SELECT * FROM setup_jenis_pelanggaran"));
$sanksi =mysqli_num_rows(mysqli_query($connect,"SELECT * FROM setup_jenis_sanksi"));
?>
