...
mysqli_query($connect,"INSERT INTO setup_kelas VALUES ('id_kelas','$nama_kelas')") or die(mysqli_error());
?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    	    <?php
                                        include '../koneksi/koneksi.php';
                                        $sql = mysqli_query($connect,"select * from setup_kelas") or die (mysqli_error());
                                        $no=1;
