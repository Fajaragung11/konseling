...
mysqli_query($connect,"INSERT INTO setup_jenis_sanksi VALUES ('id_sanksi','$nama_sanksi')") or die(mysqli_error());
?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                            <?php
                                        include '../koneksi/koneksi.php';
                                        $sql = mysqli_query($connect,"select * from setup_jenis_sanksi") or die (mysqli_error());
                                        $no=1;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a onclick="return confirm('Yakin ingin hapus data ini ??')" href="?page=guru&action=del_sanksi&kdgr=<?php echo $data['id_sanksi']; ?>">
