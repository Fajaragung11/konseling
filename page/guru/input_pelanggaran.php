...
$nama_siswa = mysqli_query($connect,"SELECT nama_siswa FROM data_siswa");
...
<select name="nm_pelanggaran" class="form-control" onchange="changeValue(this.value)" >
	<?php
	$siswa=mysqli_query($connect,"select * from setup_jenis_pelanggaran");
...
<?php 
include '../koneksi/koneksi.php';
$nm_sanksi = mysqli_query($connect,"SELECT nama_sanksi FROM setup_jenis_sanksi");
...
mysqli_query($connect,"INSERT INTO tbl_siswa_pelanggaran VALUES ('id_pelanggaran','$nm_siswa','$nm_pelanggaran','$nm_sanksi','$poin','$tgl_kejadian','$ket')") or die(mysql_error());
?>
