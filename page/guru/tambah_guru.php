...
if ($pindah) {
$sql=mysqli_query($connect,"insert into data_guru values ('$id_guru','$nama_guru','$nip','$kelamin','$alamat_guru','$telpon_guru' ,'$username','$password','$gelar','$tempat_lahir','$tanggal_lahir','$agama','$email','$nama_gambar')") or die (mysql_error());
